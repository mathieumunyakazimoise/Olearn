...
import 'package:olearn/screens/quiz_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        AppConstants.splashRoute: (context) => const Splash(),
        AppConstants.loginRoute: (context) => const Login(),
        AppConstants.signupRoute: (context) => const Signup(),
        AppConstants.onboardingRoute: (context) => const Onboarding(),
        AppConstants.homeRoute: (context) => const HomeScreen(),
        AppConstants.coursesRoute: (context) => const CoursesScreen(),
        AppConstants.lessonRoute: (context) => const LessonScreen(),
        AppConstants.quizRoute: (context) => const QuizScreen(),
        AppConstants.progressRoute: (context) => const ProgressScreen(),
        AppConstants.sharingRoute: (context) => const SharingScreen(),
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(AppLocalizations.of(context)!.counterInstruction),
            Text(
              '$_counter',
